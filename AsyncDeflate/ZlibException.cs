...
using ZErrorCode = AsyncDeflate.ZLibNative.ErrorCode;

namespace AsyncDeflate
{
    /// <summary>
    ...
    internal partial class ZLibException : IOException
    {
        ...
        {
            [SecurityCritical] get { return (int)_zlibErrorCode; }
        }

        public string ZLibErrorMessage
        {
            [SecurityCritical] get { return _zlibErrorMessage; }
        }
    }
}